...
begin
  -- Recalcular puntos solo para apuestas abiertas
  ...
  -- Limpiar puntos solo para apuestas abiertas si partidos afectados no son puntuables
  update public.predicciones pr
  set puntos = null
  from public.partidos p, public.apuestas a
  where pr.partido_id = p.id
  ...
  -- Refrescar solo rankings de apuestas abiertas
  for v_apuesta_id in
