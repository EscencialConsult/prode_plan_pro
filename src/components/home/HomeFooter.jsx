...
export default function HomeFooter() {
  return (
    <footer style={{ background: '#1f1f23', position: 'relative', overflow: 'hidden' }}>

      {/* Glow ambiental de fondo */}
      <div style={{ position:'absolute', bottom:0, left:0, width:400, height:250, background:'radial-gradient(ellipse at 0% 100%,rgba(110,111,115,.18),transparent 65%)', pointerEvents:'none' }}/>
      ...
      <div style={{ maxWidth:1200, margin:'0 auto', padding:'3.5rem 1.5rem 2.5rem' }}>
        <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(220px,1fr))', gap:'2.5rem' }}>
          ...
          <div>
            ...
            <div style={{ display:'flex', alignItems:'center', gap:'1rem', marginBottom:'1.25rem' }}>
              <img
                ...
                alt="ONE"
                style={{ height:34, width:'auto', filter:'drop-shadow(0 2px 16px rgba(255,255,255,.22))', opacity:.96 }}
              />
          ...
          {/* Col 2: Servicios */}
          <div>
            <p style={{ fontFamily:"'DM Sans',sans-serif", fontSize:'.65rem', fontWeight:700, textTransform:'uppercase', letterSpacing:'.2em', color:'rgba(255,255,255,.5)', margin:'0 0 1.1rem' }}>
              Servicios
            </p>
              ...
              {[
                ...
                <li key={label}>
                  <span style={{ fontFamily:"'DM Sans',sans-serif", fontSize:'.84rem', color:'rgba(255,255,255,.45)', display:'inline-flex', alignItems:'center', gap:'.4rem' }}>
                    <span style={{ width:4, height:4, borderRadius:'50%', background:'rgba(255,255,255,.22)', flexShrink:0 }}/>
                    {label}
                  </span>
                </li>
              ))}
      ...
      <div style={{ maxWidth:1200, margin:'0 auto', padding:'0 1.5rem' }}>
        <div style={{ height:1, background:'linear-gradient(90deg,transparent,rgba(255,255,255,.12) 20%,rgba(255,255,255,.12) 80%,transparent)' }}/>
      </div>
