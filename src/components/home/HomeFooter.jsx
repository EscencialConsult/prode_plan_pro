        ...
        <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(220px,1fr))', gap:'2.5rem' }}>
          ...
          <div>
            ...
            <div style={{ display:'flex', alignItems:'center', gap:'0.75rem', marginBottom: '0.8rem' }}>
              <img src="/imgprode/one-prode-blanco.png" alt="ONE Prode" style={{ height:20, width:'auto', opacity:.8 }} />
              <div style={{ width:1, height:20, background:'rgba(134,200,115,.15)', flexShrink:0 }} />
              <a href="https://escencialconsultora.com.ar" target="_blank" rel="noopener noreferrer" style={{ textDecoration:'none', display:'inline-flex' }}>
                <img src="./img/escencial-logoblanco.png" alt="Escencial Consultora"
                  style={{ height:28, width:'auto', opacity:.6, transition:'opacity .18s' }}
