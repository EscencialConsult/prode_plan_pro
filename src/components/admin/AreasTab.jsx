      ...
      >
        ...
        <form onSubmit={handleCreateArea} className="flex flex-col gap-4">
          ...
          <BtnGold type="submit" disabled={savingArea || !newArea.nombre.trim()} onClick={undefined}>
            {savingArea
              ? <><span className="w-4 h-4 rounded-full border-2 border-t-transparent inline-block animate-spin" style={{ borderColor: '#0057B8' }} /> Creando...</>
              : 'Crear área'
            }
          </BtnGold>
        </form>
      ...
      <div className="lg:col-span-3 flex flex-col gap-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-display text-xl" style={{ color: '#0057B8' }}>({areasAll.length})</span>
          </div>
