export default function AdminHeader({ bets = [], pendingUsers = [] }) {
  ...
  const stats = [
    ...
    { label:'Finalizadas',    value:finishedBets,        color:'#8fae27', accent:'rgba(166,201,52,.07)',border:'rgba(166,201,52,.2)',  icon:<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"/></svg> },
...
<h1 style={{ 
  ...
  PANEL DE <span style={{ color:'#A6C934' }}>CONFIGURACIÓN</span>
</h1>
      </div>
