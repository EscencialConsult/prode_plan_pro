export default function AdminHeader({ bets = [], pendingUsers = [] }) {
  ...
  const stats = [
    ...
    { label:'Finalizadas',    value:finishedBets,        color:'#0057B8', accent:'rgba(235,195,43,.07)',border:'rgba(255,255,255,.2)',  icon:<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"/></svg> },
...
<h1 style={{ 
  ...
  PANEL DE <span style={{ color:'#0057B8' }}>CONFIGURACIÓN</span>
</h1>
      </div>
