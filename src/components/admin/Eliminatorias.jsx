    ...
    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
      ...
      {isPro && form.type === 'grupos' && (
        <div className="flex flex-col gap-2 p-3 rounded-xl"
          style={{ border: '1px solid rgba(255,255,255,.25)', background: 'rgba(235,195,43,.04)' }}>
          <span className="font-body font-bold text-xs uppercase tracking-widest" style={{ color: '#5f6e8a' }}>
      ...
      <div className="flex flex-col gap-3">
        <div className="flex items-center justify-between">
          ...
          <span className="font-body text-xs" style={{ color: '#a8b2c4' }}>
            <span className="font-bold" style={{ color: '#0057B8' }}>{seleccionados}</span>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2">
              <button
                ...
                style={{
                  ...
                  color: filtroFase === 'todas' ? '#0057B8' : '#5f6e8a',
                }}
              >
                Todas las fases
              </button>
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      color: filtroFase === f ? '#0057B8' : '#5f6e8a',
                    }}
                  >
                    {LABEL_FASE[f] || f}
                    {terminada && (
        ...
        <input
          ...
          onFocus={e => { e.target.style.borderColor = '#0057B8'; e.target.style.boxShadow = '0 0 0 3px rgba(235,195,43,.12)' }}
        ...
        <div className="flex items-center justify-between gap-2 text-xs font-body">
          <button type="button" onClick={toggleVisibles} disabled={partidosFiltrados.length === 0}
            className="transition-colors disabled:opacity-40" style={{ color: '#0057B8' }}
                  ...
                  return (
                    ...
                    >
                      <span className="flex-shrink-0 w-4 h-4 rounded flex items-center justify-center"
                        style={{
                          border: `1.5px solid ${checked ? '#0057B8' : '#e8dfd0'}`,
                          background: checked ? '#0057B8' : 'transparent',
                          transition: 'all .15s',
                        }}>
                        {checked && (
