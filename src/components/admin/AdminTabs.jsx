        ...
        return (
          <button
            ...
            style={{
              ...
              color: active ? '#E30613' : '#6B7280',
              border: active ? '1px solid rgba(227,6,19,0.45)' : '1px solid transparent',
            }}
          >
            ...
            {item.count > 0 && (
              <span
                ...
                style={{
                  background: active ? 'rgba(227,6,19,0.18)' : 'rgba(7,26,58,0.08)',
                  color: active ? '#E30613' : '#071A3A',
                }}
              >
                {item.count}
              </span>
