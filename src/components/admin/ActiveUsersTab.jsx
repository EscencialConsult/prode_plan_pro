    ...
    <div className="animate-fade-in delay-2">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        ...
        <button
          ...
          style={{
            background: loadingActiveUsers ? 'rgba(227,6,19,0.1)' : '#fff',
            border: '1.5px solid #f0eadb',
            color: loadingActiveUsers ? '#A8030C' : '#5f6e8a',
            ...
            return (
              ...
              >
                ...
                <span className="inline-flex items-center px-2.5 py-1 rounded-lg text-[11px] font-body font-semibold w-fit uppercase tracking-wider"
                  style={{
                    background: u.tipo_usuario === 'jefe' ? 'rgba(227,6,19,0.1)' : 'rgba(12,24,43,0.05)',
                    color: u.tipo_usuario === 'jefe' ? '#A8030C' : '#5f6e8a',
                    border: `1px solid ${u.tipo_usuario === 'jefe' ? 'rgba(227,6,19,0.25)' : 'rgba(12,24,43,0.1)'}`,
                  }}>
