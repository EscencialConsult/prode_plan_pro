...
function Step({ num, title, children }) {
  return (
    <div style={{
      ...
      onMouseEnter={e=>{ e.currentTarget.style.borderColor='rgba(125,211,252,.5)'; e.currentTarget.style.transform='translateX(3px)'; e.currentTarget.style.boxShadow='0 4px 14px rgba(12,24,43,.06)' }}
  ...
  if (variant==='solid') {
    return (
      <button onClick={onClick} style={{
        ...
        boxShadow:'0 6px 18px rgba(125,211,252,.35)',
        transition:'all .18s ease',
      }}
        onMouseEnter={e=>{ e.currentTarget.style.background=C.goldLt; e.currentTarget.style.transform='translateY(-1px)'; e.currentTarget.style.boxShadow='0 8px 22px rgba(125,211,252,.5)' }}
        onMouseLeave={e=>{ e.currentTarget.style.background=C.gold; e.currentTarget.style.transform='none'; e.currentTarget.style.boxShadow='0 6px 18px rgba(125,211,252,.35)' }}>
        {children}
        ...
        <main ref={contentRef} style={{
          ...
          <section id="manual-premios" style={{ marginBottom:48, scrollMarginTop:24 }}>
            ...
            <div style={{
              ...
              {[
                { emoji:'🥇', pos:'1° PUESTO', label:'Ganador principal de la apuesta', accent:C.gold,    bg:'rgba(125,211,252,.08)' },
              ...
              <div style={{ display:'flex', flexWrap:'wrap', gap:8 }}>
                {[
                  ...
                  <button key={path} onClick={()=>navigate(path)}
                    ...
                    onMouseEnter={e=>{ e.currentTarget.style.borderColor=C.gold; e.currentTarget.style.background='rgba(125,211,252,.08)'; e.currentTarget.style.color=C.goldDk }}
