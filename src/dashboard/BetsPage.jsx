          ...
          {bet.partidos.slice(0,3).map(m=>{
            ...
            return(
              <div key={m.id} style={{display:'grid',gridTemplateColumns:'1fr auto 1fr',alignItems:'center',gap:'.6rem',padding:'.55rem .75rem',borderRadius:9,background:pred?'rgba(192,39,39,.05)':'rgba(31,31,35,.02)',border:pred?'1px solid rgba(192,39,39,.2)':'1px solid #e4e4e7'}}>
                <span style={{fontWeight:500,fontSize:'.8rem',color:'#1f1f23',overflow:'hidden',textOverflow:'ellipsis',whiteSpace:'nowrap'}}>{nombreLocal}</span>
                ...
                <span style={{fontWeight:500,fontSize:'.8rem',color:'#1f1f23',textAlign:'right',overflow:'hidden',textOverflow:'ellipsis',whiteSpace:'nowrap'}}>{nombreVisitante}</span>
              </div>
            )
          })}
