...
function ToastItem({ toast, onClose }) {
  ...
  const STYLES = {
    success: {
      bg: 'linear-gradient(135deg, #111811 0%, #1C261D 100%)',
      border: 'rgba(134,200,115, 0.4)',
      color: '#86C873',
      iconBg: 'rgba(134,200,115, 0.15)',
      icon: (
    ...
    error: {
      bg: 'linear-gradient(135deg, #111811 0%, #1f0f15 100%)',
  ...
  return (
    <div style={{
      ...
      boxShadow: '0 10px 40px rgba(0,0,0,.45), 0 0 24px rgba(134,200,115,.08)',
...
function ConfirmDialog({ opts, onResolve }) {
  const TYPE = {
    ...
    warning: {
      iconBg: 'rgba(134,200,115, 0.15)',
      iconColor: '#86C873',
      btnBg: 'linear-gradient(135deg, #86C873 0%, #5A9E4A 100%)',
      btnColor: '#0a0f0a',
      btnShadow: '0 6px 24px rgba(134,200,115,.35)',
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
          <circle cx="12" cy="12" r="10" />
    ...
    info: {
      iconBg: 'rgba(134,200,115, 0.15)',
      iconColor: '#86C873',
      btnBg: 'linear-gradient(135deg, #86C873 0%, #7af5f8 100%)',
      btnColor: '#0F1410',
      btnShadow: '0 6px 24px rgba(134,200,115,.35)',
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
    ...
    >
      <div
        ...
        style={{
          ...
          background: 'linear-gradient(145deg, rgba(30,43,31,0.98) 0%, rgba(28,38,29,0.98) 100%)',
