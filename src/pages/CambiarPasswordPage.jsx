    ...
    <div>
      ...
      <input
        ...
        onFocus={e => {
          ...
          e.target.style.boxShadow = '0 0 0 3px rgba(192,39,39,.15)'
        }}
        onBlur={e => {
      ...
      <div style={{ maxWidth: 460, margin: '0 auto', padding: '2rem 1.25rem 3rem' }}>
        ...
        <div style={{ marginBottom: '1.4rem' }}>
          <div style={{
            ...
            letterSpacing: '.08em', color: '#9e1f1f', marginBottom: '.35rem',
          }}>
          ...
          <h1 style={{
            ...
            fontSize: '2rem', color: '#1f1f23', margin: 0, letterSpacing: '.02em',
          }}>
            Cambiar contraseña
          </h1>
          <p style={{ fontSize: '.85rem', color: '#6e6f73', margin: '.3rem 0 0' }}>
        ...
        <div style={{
          ...
          border: '1px solid #e4e4e7',
          borderRadius: 16,
          boxShadow: '0 12px 32px rgba(31,31,35,.08)',
          padding: '1.5rem',
        }}>
          {done ? (
            <div style={{ textAlign: 'center', padding: '.5rem 0' }}>
              ...
              <h2 style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: '1.5rem', color: '#1f1f23', margin: '0 0 .4rem' }}>
                ¡Contraseña actualizada!
              </h2>
              <p style={{ fontSize: '.85rem', color: '#6e6f73', margin: '0 0 1.3rem' }}>
              ...
              <div style={{ display: 'flex', gap: '.6rem', justifyContent: 'center' }}>
                <button
                  ...
                  style={{
                    background: '#1f1f23', color: '#fff', border: 'none', borderRadius: 999,
                ...
                <button
                  ...
                  style={{
                    background: 'transparent', color: '#6e6f73', border: '1px solid #e4e4e7',
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                <label style={{ display: 'inline-flex', alignItems: 'center', gap: '.4rem', fontSize: '.78rem', color: '#6e6f73', cursor: 'pointer' }}>
                  <input
                    type="checkbox"
                    checked={verPass}
                    onChange={e => setVerPass(e.target.checked)}
                    style={{ accentColor: '#c02727' }}
                  />
                  Mostrar contraseñas
                </label>
              ...
              <button
                ...
                style={{
                  marginTop: '.2rem',
                  background: loading ? '#a85050' : '#c02727',
                  ...
                  boxShadow: '0 8px 24px rgba(192,39,39,.28)',
              ...
              >
                {loading ? (
                  <>
                    <span style={{
                      width: 15, height: 15, border: '2px solid rgba(20,20,22,.35)',
                      borderTopColor: '#141416', borderRadius: '50%',
