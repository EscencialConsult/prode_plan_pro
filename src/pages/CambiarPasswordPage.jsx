    ...
    <div>
      ...
      <input
        ...
        onFocus={e => {
          ...
          e.target.style.boxShadow = '0 0 0 3px rgba(125,211,252,.15)'
        }}
        onBlur={e => {
      ...
      <div style={{ maxWidth: 460, margin: '0 auto', padding: '2rem 1.25rem 3rem' }}>
        ...
        <div style={{ marginBottom: '1.4rem' }}>
          <div style={{
            ...
            letterSpacing: '.08em', color: '#0ea5e9', marginBottom: '.35rem',
          }}>
          ...
          {done ? (
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              ...
              <button
                ...
                style={{
                  marginTop: '.2rem',
                  background: loading ? '#d9c98f' : '#7dd3fc',
                  ...
                  boxShadow: '0 8px 24px rgba(125,211,252,.28)',
