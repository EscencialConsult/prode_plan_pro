    ...
    <AppShell>
      ...
      <div style={{ maxWidth: 1400, margin: '0 auto', padding: '2rem 1.5rem 3rem' }}>
        ...
        <div className="mb-6 h-px"
          style={{ background: 'linear-gradient(90deg,transparent,rgba(227,6,19,.25) 30%,rgba(227,6,19,.25) 70%,transparent)' }} />
          ...
          <div className="grid gap-6">
            <div>
              ...
              <form onSubmit={handleCreateArea} className="space-y-3">
                <div>
                  <label className="text-[11px] font-body font-bold uppercase tracking-[0.15em] mb-2 block" style={{ color: '#A8030C' }}>
                    Nombre del área *
                  </label>
                  <input
                    type="text"
                ...
                <button
                  ...
                  style={{
                    background: 'linear-gradient(135deg, #E30613 0%, #d4a017 100%)',
                    color: '#0a1226',
                  }}
                >
                ...
                <div className="space-y-2">
                  {areasAll.map(a => (
                    <div
                      ...
                      style={{
                        background: a.activa ? 'rgba(227,6,19,0.05)' : 'rgba(95,110,138,0.04)',
                        border: `1px solid ${a.activa ? 'rgba(227,6,19,0.15)' : 'rgba(95,110,138,0.15)'}`,
                      }}
                    >
                      {editingArea?.id === a.id ? (
  ...
  <div className="animate-fade-in delay-2">
    ...
    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
      ...
      <button
        ...
        style={{
          background: loadingUsers ? 'rgba(227,6,19,0.1)' : '#fff',
          border: '1.5px solid #f0eadb',
          color: loadingUsers ? '#A8030C' : '#5f6e8a',
    ...
    <div className="mb-6 flex gap-2 max-w-md">
      ...
      <button
        ...
        style={{
          background: 'linear-gradient(135deg, #E30613 0%, #d4a017 100%)',
          color: '#0a1226',
          boxShadow: '0 2px 8px rgba(227,6,19,0.15)',
        }}
      >
        Buscar
      </button>
    ...
    {loadingUsers && pendingUsers.length === 0 ? (
      ...
      >
        <div className="w-16 h-16 mx-auto mb-5 rounded-2xl flex items-center justify-center"
          ...
          <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#A8030C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        {pendingUsers.map(u => {
          ...
          return (
            <div
              ...
              style={{
                background: '#fff',
                border: `1.5px solid ${isApproving ? '#E30613' : isRejecting ? '#ff4d6d' : '#f0eadb'}`,
                  ...
                  {!isApproving && !isRejecting && (
                    <div className="flex gap-2 flex-shrink-0">
                      <button
                        ...
                        onMouseLeave={e => {
                          e.currentTarget.style.boxShadow = '0 2px 8px rgba(227,6,19,0.25)'
                          e.currentTarget.style.transform = 'translateY(0)'
                        }}
                      >
                        Aprobar
                    ...
                    {isPro && (
                      <div>
                          ...
                          {[{ val: 'general', label: 'General' }, { val: 'jefe', label: 'Jefe de Área' }].map(({ val, label }) => {
                            ...
                            return (
                              <button
                                ...
                                style={{
                                  background: sel ? '#E30613' : '#fff',
                                  border: `1.5px solid ${sel ? '#E30613' : '#f0eadb'}`,
                        ...
                        {approvingUser.tipo_usuario === 'jefe' && (
                          <p className="text-[10px] font-body mt-2" style={{ color: '#A8030C' }}>
                            ...
                            {areas.map(a => {
                              ...
                              return (
                                <button
                                  ...
                                  className="px-4 py-2 rounded-full text-xs font-body font-bold transition-all"
                                  style={{
                                    background: isActive ? '#E30613' : '#fff',
                                    border: `1.5px solid ${isActive ? '#E30613' : '#f0eadb'}`,
                    ...
                    {!isPro && (
                      ...
                      >
                        <p className="text-xs font-body flex items-start gap-2" style={{ color: '#5f6e8a' }}>
                          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#A8030C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="flex-shrink-0 mt-0.5">
                            <circle cx="12" cy="12" r="10" />
                      ...
                      <button
                        ...
                        style={{
                          background: approvingInProgress 
                            ? 'rgba(227,6,19,0.3)' 
                            : 'linear-gradient(135deg, #E30613 0%, #d4a017 100%)',
                          color: '#0a1226',
                          boxShadow: approvingInProgress ? 'none' : '0 2px 8px rgba(227,6,19,0.25)',
                        }}
                      >
                        {approvingInProgress && (
                          <span 
