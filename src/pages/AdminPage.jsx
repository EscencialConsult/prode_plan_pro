    ...
    <AppShell>
      ...
      <div style={{ maxWidth: 1400, margin: '0 auto', padding: '2rem 1.5rem 3rem' }}>
        ...
        <div className="mb-6 h-px"
          style={{ background: 'linear-gradient(90deg,transparent,rgba(166,201,52,.25) 30%,rgba(166,201,52,.25) 70%,transparent)' }} />
          ...
          <div className="grid gap-6">
            <div>
              ...
              <form onSubmit={handleCreateArea} className="space-y-3">
                <div>
                  <label className="text-[11px] font-body font-bold uppercase tracking-[0.15em] mb-2 block" style={{ color: '#8fae27' }}>
                    Nombre del área *
                  </label>
                  <input
                    type="text"
                ...
                <button
                  ...
                  style={{
                    background: 'linear-gradient(135deg, #A6C934 0%, #d4a017 100%)',
                    color: '#0a1226',
                  }}
                >
                ...
                <div className="space-y-2">
                  {areasAll.map(a => (
                    <div
                      ...
                      style={{
                        background: a.activa ? 'rgba(166,201,52,0.05)' : 'rgba(95,110,138,0.04)',
                        border: `1px solid ${a.activa ? 'rgba(166,201,52,0.15)' : 'rgba(95,110,138,0.15)'}`,
                      }}
                    >
                      {editingArea?.id === a.id ? (
  ...
  <div className="animate-fade-in delay-2">
    ...
    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
      ...
      <button
        ...
        style={{
          background: loadingUsers ? 'rgba(166,201,52,0.1)' : '#fff',
          border: '1.5px solid #f0eadb',
          color: loadingUsers ? '#8fae27' : '#5f6e8a',
        ...
        onMouseEnter={e => {
          if (!loadingUsers) {
            ...
            e.currentTarget.style.boxShadow = '0 4px 12px rgba(166,201,52,0.15)'
          }
        }}
        onMouseLeave={e => {
    ...
    <div className="mb-6 flex gap-2 max-w-md">
      ...
      <button
        ...
        style={{
          background: 'linear-gradient(135deg, #A6C934 0%, #d4a017 100%)',
          color: '#0a1226',
          boxShadow: '0 2px 8px rgba(166,201,52,0.15)',
        }}
      >
        Buscar
      </button>
    ...
    {loadingUsers && pendingUsers.length === 0 ? (
      <div className="text-center py-20">
        <span className="inline-block w-10 h-10 border-3 border-t-transparent rounded-full animate-spin"
          style={{ borderColor: '#A6C934', borderTopColor: 'transparent' }} />
      ...
      >
        <div className="w-16 h-16 mx-auto mb-5 rounded-2xl flex items-center justify-center"
          style={{ background: 'rgba(166,201,52,0.08)', border: '1px solid rgba(166,201,52,0.2)' }}>
          <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#8fae27" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        {pendingUsers.map(u => {
          ...
          return (
            <div
              ...
              style={{
                background: '#fff',
                border: `1.5px solid ${isApproving ? '#A6C934' : isRejecting ? '#ff4d6d' : '#f0eadb'}`,
                  ...
                  <div className="flex items-center gap-4 min-w-0 flex-1">
                    ...
                    <div
                      ...
                      style={{
                        background: 'linear-gradient(135deg, #A6C934 0%, #d4a017 100%)',
                        color: '#0a1226',
                        boxShadow: '0 4px 12px rgba(166,201,52,0.25)',
                      }}
                    >
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="flex items-center gap-2">
                        <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-[10px] font-body font-semibold uppercase tracking-wider"
                          style={{ 
                            background: 'rgba(166,201,52,0.08)', 
                            color: '#8fae27',
                            border: '1px solid rgba(166,201,52,0.2)'
                          }}>
                    ...
                    <div className="flex gap-2 flex-shrink-0">
                      <button
                        ...
                        style={{
                          background: 'linear-gradient(135deg, #A6C934 0%, #d4a017 100%)',
                          color: '#0a1226',
                          boxShadow: '0 2px 8px rgba(166,201,52,0.25)',
                        }}
                        onMouseEnter={e => {
                          e.currentTarget.style.boxShadow = '0 4px 16px rgba(166,201,52,0.4)'
                          e.currentTarget.style.transform = 'translateY(-2px)'
                        }}
                        onMouseLeave={e => {
                          e.currentTarget.style.boxShadow = '0 2px 8px rgba(166,201,52,0.25)'
                          e.currentTarget.style.transform = 'translateY(0)'
                        }}
                      >
                        Aprobar
              ...
              {isApproving && (
                <div className="px-5 pb-5">
                    ...
                    {isPro && (
                      <div>
                          ...
                          {[{ val: 'general', label: 'General' }, { val: 'jefe', label: 'Jefe de Área' }].map(({ val, label }) => {
                            ...
                            return (
                              <button
                                ...
                                style={{
                                  background: sel ? '#A6C934' : '#fff',
                                  border: `1.5px solid ${sel ? '#A6C934' : '#f0eadb'}`,
                        ...
                        {approvingUser.tipo_usuario === 'jefe' && (
                          <p className="text-[10px] font-body mt-2" style={{ color: '#8fae27' }}>
                    ...
                    <div
                      ...
                      style={{
                        background: 'rgba(166,201,52,0.04)',
                        border: '1.5px solid rgba(166,201,52,0.15)',
                      }}
                    >
                            ...
                            {areas.map(a => {
                              ...
                              return (
                                <button
                                  ...
                                  className="px-4 py-2 rounded-full text-xs font-body font-bold transition-all"
                                  style={{
                                    background: isActive ? '#A6C934' : '#fff',
                                    border: `1.5px solid ${isActive ? '#A6C934' : '#f0eadb'}`,
                    ...
                    {!isPro && (
                      <div
                        ...
                        style={{
                          background: 'rgba(166,201,52,0.06)',
                          border: '1px solid rgba(166,201,52,0.15)',
                        }}
                      >
                        <p className="text-xs font-body flex items-start gap-2" style={{ color: '#5f6e8a' }}>
                          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#8fae27" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="flex-shrink-0 mt-0.5">
                            <circle cx="12" cy="12" r="10" />
                      ...
                      <button
                        ...
                        style={{
                          background: approvingInProgress 
                            ? 'rgba(166,201,52,0.3)' 
                            : 'linear-gradient(135deg, #A6C934 0%, #d4a017 100%)',
                          color: '#0a1226',
                          boxShadow: approvingInProgress ? 'none' : '0 2px 8px rgba(166,201,52,0.25)',
                        }}
                      >
                        {approvingInProgress && (
                          <span 
