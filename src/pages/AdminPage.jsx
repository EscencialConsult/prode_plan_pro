...
function getBetStatusColor(bet) {
  if (isBetOpen(bet)) return { color: 'var(--color-accent)', bg: 'rgba(134,200,115,0.12)', border: 'rgba(134,200,115,0.4)', label: 'Activa' }
  ...
  return (
    <AppShell>
      ...
      <div style={{ maxWidth: 1400, margin: '0 auto', padding: '2rem 1.5rem 3rem' }}>
        ...
        <AdminHeader bets={bets} pendingUsers={pendingUsers} isPro={isPro} />

        {/* Divider */}
        <div className="mb-6 h-px"
          style={{ background: 'linear-gradient(90deg,transparent,rgba(134,200,115,.25) 30%,rgba(134,200,115,.25) 70%,transparent)' }} />
...
/>
        ...
        {tab === 'Areas' && isPro && (
          <div className="grid gap-6">
            <div>
              <h3 className="font-display text-xl mb-4" style={{ color: '#0a0f0a' }}>
                Crear nueva área
              </h3>
              <form onSubmit={handleCreateArea} className="space-y-3">
                <div>
                  <label className="text-[11px] font-body font-bold uppercase tracking-[0.15em] mb-2 block" style={{ color: '#5A9E4A' }}>
                    Nombre del área *
                  </label>
                  <input
                    type="text"
            ...
            >
              ...
              {loadingAreas ? (
                <p className="text-sm font-body" style={{ color: '#4a6b50' }}>Cargando...</p>
              ) : areasAll.length === 0 ? (
                <p className="text-sm font-body" style={{ color: '#4a6b50' }}>
                ...
                <div className="space-y-2">
                  {areasAll.map(a => (
                    <div
                      ...
                      style={{
                        background: a.activa ? 'rgba(134,200,115,0.05)' : 'rgba(95,110,138,0.04)',
                        border: `1px solid ${a.activa ? 'rgba(134,200,115,0.15)' : 'rgba(95,110,138,0.15)'}`,
                      }}
                    >
                      {editingArea?.id === a.id ? (
                        <div className="flex-1 space-y-2">
                          ...
                          <div className="flex gap-2">
                            <button
                              ...
                              style={{ background: '#86C873', color: '#0a0f0a' }}
                            >
                              Guardar
                            </button>
                            <button
                        ...
                        <>
                          <div className="flex-1">
                            <p className="font-body font-bold text-sm" style={{ color: a.activa ? '#0a0f0a' : '#9aa5b8' }}>
                              {a.nombre}
                              {!a.activa && <span className="ml-2 text-xs font-normal">(inactiva)</span>}
                            </p>
                            {a.descripcion && (
                              <p className="text-xs font-body mt-1" style={{ color: '#4a6b50' }}>
                                {a.descripcion}
                              </p>
                            )}
                          </div>
                          <div className="flex gap-2 flex-shrink-0">
                            <button
                              ...
                              style={{ background: 'transparent', border: '1px solid rgba(17,24,17,.2)', color: '#4a6b50' }}
                            >
                              Editar
                            </button>
                            <button
  ...
  <div className="animate-fade-in delay-2">
    ...
    <div className="flex justify-between items-start gap-4 mb-6 w-full">
      ...
      <button
        ...
        style={{
          background: loadingUsers ? 'rgba(134,200,115,0.1)' : '#fff',
          border: '1.5px solid #e2eede',
          color: loadingUsers ? '#5A9E4A' : '#4a6b50',
    ...
    {loadingUsers && pendingUsers.length === 0 ? (
      ...
      >
        <div className="w-16 h-16 mx-auto mb-5 rounded-2xl flex items-center justify-center"
          style={{ background: 'rgba(134,200,115,0.08)', border: '1px solid rgba(134,200,115,0.2)' }}>
        ...
        {pendingUsers.map(u => {
          ...
          return (
            <div
              ...
              style={{
                background: '#fff',
                border: `1.5px solid ${isApproving ? '#86C873' : isRejecting ? '#ff4d6d' : '#e2eede'}`,
                  ...
                  <div className="flex items-center gap-4 min-w-0 flex-1">
                    ...
                    <div
                      ...
                      style={{
                        background: 'linear-gradient(135deg, #86C873 0%, #86C873 100%)',
                        color: '#0a0f0a',
                        boxShadow: '0 4px 12px rgba(134,200,115,0.25)',
                      }}
                    >
                    ...
                    <div className="flex gap-2 flex-shrink-0">
                      <button
                        ...
                        style={{
                          background: 'linear-gradient(135deg, #86C873 0%, #86C873 100%)',
                          color: '#0a0f0a',
                          boxShadow: '0 2px 8px rgba(134,200,115,0.25)',
                        }}
                        onMouseEnter={e => {
                          e.currentTarget.style.boxShadow = '0 4px 16px rgba(134,200,115,0.4)'
                          e.currentTarget.style.transform = 'translateY(-2px)'
                        }}
                        onMouseLeave={e => {
                          e.currentTarget.style.boxShadow = '0 2px 8px rgba(134,200,115,0.25)'
                          e.currentTarget.style.transform = 'translateY(0)'
                        }}
                      >
                        Aprobar
                ...
                <div className="px-5 pb-5">
                  ...
                  >
                    <div className="flex items-start gap-3 mb-4">
                      ...
                      <div>
                        <p className="font-body font-bold text-sm mb-1" style={{ color: '#0a0f0a' }}>
                          ¿Estás seguro de rechazar este usuario?
                        </p>
                        <p className="text-xs font-body" style={{ color: '#4a6b50' }}>
                          Esta acción eliminará permanentemente la solicitud de <strong style={{ color: '#0a0f0a' }}>{u.nombre}</strong>. No se podrá deshacer.
                        </p>
                      </div>
                    </div>
              ...
              {isApproving && (
                <div className="px-5 pb-5">
                    ...
                    {isPro && (
                      <div>
                          ...
                          {[{ val: 'general', label: 'General' }, { val: 'jefe', label: 'Jefe de Área' }].map(({ val, label }) => {
                            ...
                            return (
                              <button
                                ...
                                style={{
                                  background: sel ? '#86C873' : '#fff',
                                  border: `1.5px solid ${sel ? '#86C873' : '#e2eede'}`,
                                  color: sel ? '#0a0f0a' : '#4a6b50',
                                }}
                              >
                                {label}
                              </button>
                        ...
                        {approvingUser.tipo_usuario === 'jefe' && (
                          <p className="text-[10px] font-body mt-2" style={{ color: '#5A9E4A' }}>
                    ...
                    <div
                      ...
                      style={{
                        background: 'rgba(134,200,115,0.04)',
                        border: '1.5px solid rgba(134,200,115,0.15)',
                      }}
                    >
                        ...
                        {areas.length === 0 ? (
                          ...
                          >
                            <div className="flex items-start gap-3">
                              ...
                              <div>
                                <p className="text-xs font-body font-semibold mb-1" style={{ color: '#0a0f0a' }}>
                                  No hay áreas disponibles
                                </p>
                                <p className="text-[10px] font-body" style={{ color: '#4a6b50' }}>
                            ...
                            {areas.map(a => {
                              ...
                              return (
                                <button
                                  ...
                                  className="px-4 py-2 rounded-full text-xs font-body font-bold transition-all"
                                  style={{
                                    background: isActive ? '#86C873' : '#fff',
                                    border: `1.5px solid ${isActive ? '#86C873' : '#e2eede'}`,
                                    color: isActive ? '#0a0f0a' : '#4a6b50',
                                  }}
                                >
                                  {a.nombre}
                                </button>
                    ...
                    {!isPro && (
                      ...
                      >
                        <p className="text-xs font-body flex items-start gap-2" style={{ color: '#4a6b50' }}>
                          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#5A9E4A" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="flex-shrink-0 mt-0.5">
                            <circle cx="12" cy="12" r="10" />
                      ...
                      <button
                        ...
                        style={{
                          background: approvingInProgress 
                            ? 'rgba(134,200,115,0.3)' 
                            : 'linear-gradient(135deg, #86C873 0%, #86C873 100%)',
                          color: '#0a0f0a',
                          boxShadow: approvingInProgress ? 'none' : '0 2px 8px rgba(134,200,115,0.25)',
                        }}
                      >
                        {approvingInProgress && (
                          <span 
