      ...
      <nav style={{
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 1.5rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
            ...
            />
            <div style={{ width: 1, height: 'clamp(35px, 5vw, 45px)', background: 'rgba(134,200,115,.25)', flexShrink: 0 }} />
            <div style={{ fontFamily:"'Bebas Neue',sans-serif", fontSize: 'clamp(1.4rem, 4vw, 1.45rem)', letterSpacing: '.18em', lineHeight: 1, userSelect: 'none' }}>
