            ...
            {done ? (
              ...
              <div className="text-center py-4">
                ...
                <div className="rp-pop w-20 h-20 mx-auto mb-6 rounded-full flex items-center justify-center"
                  style={{ background: 'linear-gradient(135deg, rgba(192,39,39,.25), rgba(192,39,39,.1))', border: '2px solid rgba(192,39,39,.5)', boxShadow: '0 0 0 6px rgba(192,39,39,.08)' }}>
                ...
                <p className="font-body text-sm leading-relaxed mb-2 max-w-xs mx-auto" style={{ color: 'rgba(255,255,255,.55)' }}>
                  Tu cuenta está <strong style={{ color: '#c02727' }}>pendiente de aprobación</strong> por el administrador.
                </p>
                ...
                <div className="h-px mb-6 mx-auto w-3/4"
                  style={{ background: 'linear-gradient(90deg, transparent, rgba(192,39,39,.2), transparent)' }} />

                <Link
                  to="/login"
                  className="inline-flex items-center gap-2 font-body font-bold text-sm px-6 py-3 rounded-full transition-all"
                  style={{ background: '#c02727', color: '#ffffff', textDecoration: 'none', boxShadow: '0 6px 20px rgba(192,39,39,.28)' }}
              ...
              <>
                ...
                <div className="mb-7">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="font-body text-xs uppercase tracking-widest font-bold" style={{ color: 'rgba(192,39,39,.7)' }}>
                      Mundial 2026
                    </span>
                  </div>
                ...
                {/* Divider */}
                <div className="h-px mb-7" style={{ background: 'linear-gradient(90deg, transparent, rgba(192,39,39,.2) 50%, transparent)' }} />
                ...
                <Link
                  ...
                  onMouseEnter={e => { e.currentTarget.style.borderColor = 'rgba(192,39,39,.5)'; e.currentTarget.style.color = '#c02727'; e.currentTarget.style.background = 'rgba(192,39,39,.06)' }}
