...
import AlianzaLogo from '../components/brand/AlianzaLogo.jsx'
...
export default function RegisterPage() {
  ...
  const onFocus = e => {
    e.target.style.borderColor = 'rgba(166, 201, 52,.55)'
    e.target.style.background  = 'rgba(166, 201, 52,.06)'
    e.target.style.boxShadow   = '0 0 0 3px rgba(166, 201, 52,.1)'
  }
  const onBlur = e => {
    ...
    <>
      ...
      >
        ...
        <div className="absolute inset-0 pointer-events-none" style={{
          background: 'radial-gradient(ellipse 55% 45% at 20% 25%, rgba(166, 201, 52,.16), transparent 55%)'
        }} />
        {/* Blue glow */}
        <div className="absolute inset-0 pointer-events-none" style={{
        ...
        {/* ── Logo / Brand ── */}
        <div className="relative z-10 flex flex-col items-center mb-6 rp-card" style={{ filter: 'drop-shadow(0 4px 16px rgba(0,0,0,0.5))' }}>
          <AlianzaLogo size={140} light />
        </div>
        ...
        <div
          ...
          style={{
            ...
            border: '1px solid rgba(166, 201, 52,.25)',
            borderRadius: 20,
            boxShadow: '0 32px 80px rgba(0,0,0,.6), 0 0 0 1px rgba(166, 201, 52,.08), inset 0 1px 0 rgba(255,255,255,.05)',
        ...
        >
          ...
          <div className="rounded-t-[20px] h-0.5 w-full"
            style={{ background: 'linear-gradient(90deg, transparent, #A6C934 30%, #A6C934 70%, transparent)' }} />
            ...
            {done ? (
              ...
              <div className="text-center py-4">
                ...
                <div className="rp-pop w-20 h-20 mx-auto mb-6 rounded-full flex items-center justify-center"
                  style={{ background: 'linear-gradient(135deg, rgba(166, 201, 52,.25), rgba(166, 201, 52,.1))', border: '2px solid rgba(166, 201, 52,.5)', boxShadow: '0 0 0 6px rgba(166, 201, 52,.08)' }}>
                  <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#A6C934" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                ...
                <p className="font-body text-sm leading-relaxed mb-2 max-w-xs mx-auto" style={{ color: 'rgba(255,255,255,.55)' }}>
                  Tu cuenta está <strong style={{ color: '#A6C934' }}>pendiente de aprobación</strong> por el administrador.
                </p>
                ...
                <div className="h-px mb-6 mx-auto w-3/4"
                  style={{ background: 'linear-gradient(90deg, transparent, rgba(166, 201, 52,.2), transparent)' }} />

                <Link
                  to="/login"
                  className="inline-flex items-center gap-2 font-body font-bold text-sm px-6 py-3 rounded-full transition-all"
                  style={{ background: '#A6C934', color: '#040D1D', textDecoration: 'none', boxShadow: '0 6px 20px rgba(166, 201, 52,.28)' }}
                  onMouseEnter={e => { e.currentTarget.style.background = '#bde04b'; e.currentTarget.style.transform = 'translateY(-1px)' }}
                  onMouseLeave={e => { e.currentTarget.style.background = '#A6C934'; e.currentTarget.style.transform = '' }}
                >
              ...
              <>
                ...
                <div className="mb-7">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="font-body text-xs uppercase tracking-widest font-bold" style={{ color: 'rgba(166, 201, 52,.7)' }}>
                      Mundial 2026
                    </span>
                  </div>
                ...
                {/* Divider */}
                <div className="h-px mb-7" style={{ background: 'linear-gradient(90deg, transparent, rgba(166, 201, 52,.2) 50%, transparent)' }} />
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <button
                    ...
                    style={{ background: '#A6C934', color: '#040D1D', boxShadow: '0 8px 28px rgba(166, 201, 52,.3)' }}
                    onMouseEnter={e => { if (!loading) { e.currentTarget.style.background = '#bde04b'; e.currentTarget.style.transform = 'translateY(-2px)'; e.currentTarget.style.boxShadow = '0 12px 36px rgba(166, 201, 52,.45)' } }}
                    onMouseLeave={e => { if (!loading) { e.currentTarget.style.background = '#A6C934'; e.currentTarget.style.transform = ''; e.currentTarget.style.boxShadow = '0 8px 28px rgba(166, 201, 52,.3)' } }}
                  >
                    {loading ? (
                      <>
                ...
                <Link
                  ...
                  onMouseEnter={e => { e.currentTarget.style.borderColor = 'rgba(166, 201, 52,.5)'; e.currentTarget.style.color = '#A6C934'; e.currentTarget.style.background = 'rgba(166, 201, 52,.06)' }}
        ...
        {!done && (
          <div className="relative z-10 flex flex-col items-center gap-2 mt-6 rp-card" style={{ animationDelay: '.2s' }}>
            <Link to="/"
              ...
              onMouseEnter={e => { e.currentTarget.style.color = '#A6C934' }}
