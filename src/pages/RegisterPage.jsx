...
export default function RegisterPage() {
  ...
  const onFocus = e => {
    e.target.style.borderColor = 'rgba(125,211,252,.55)'
    e.target.style.background  = 'rgba(125,211,252,.06)'
    ...
    <>
      ...
      >
        ...
        <div className="absolute inset-0 pointer-events-none" style={{
          background: 'radial-gradient(ellipse 55% 45% at 20% 25%, rgba(125,211,252,.16), transparent 55%)'
        }} />
        {/* Blue glow */}
        <div className="absolute inset-0 pointer-events-none" style={{
        ...
        <div
          ...
          style={{
            ...
            borderRadius: 20,
            boxShadow: '0 32px 80px rgba(0,0,0,.6), 0 0 0 1px rgba(125,211,252,.08), inset 0 1px 0 rgba(255,255,255,.05)',
        ...
        >
          ...
          <div className="rounded-t-[20px] h-0.5 w-full"
            style={{ background: 'linear-gradient(90deg, transparent, #7dd3fc 30%, #7dd3fc 70%, transparent)' }} />
            ...
            {done ? (
              ...
              <div className="text-center py-4">
                ...
                <div className="rp-pop w-20 h-20 mx-auto mb-6 rounded-full flex items-center justify-center"
                  style={{ background: 'linear-gradient(135deg, rgba(125,211,252,.25), rgba(125,211,252,.1))', border: '2px solid rgba(125,211,252,.5)', boxShadow: '0 0 0 6px rgba(125,211,252,.08)' }}>
                  <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#7dd3fc" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                ...
                <p className="font-body text-sm leading-relaxed mb-2 max-w-xs mx-auto" style={{ color: 'rgba(255,255,255,.55)' }}>
                  Tu cuenta está <strong style={{ color: '#7dd3fc' }}>pendiente de aprobación</strong> por el administrador.
                </p>
                ...
                <div className="h-px mb-6 mx-auto w-3/4"
                  style={{ background: 'linear-gradient(90deg, transparent, rgba(125,211,252,.2), transparent)' }} />

                <Link
                  to="/login"
                  className="inline-flex items-center gap-2 font-body font-bold text-sm px-6 py-3 rounded-full transition-all"
                  style={{ background: '#7dd3fc', color: '#05090f', textDecoration: 'none', boxShadow: '0 6px 20px rgba(125,211,252,.28)' }}
              ...
              <>
                ...
                <div className="mb-7">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="font-body text-xs uppercase tracking-widest font-bold" style={{ color: 'rgba(125,211,252,.7)' }}>
                      Mundial 2026
                    </span>
                  </div>
                ...
                {/* Divider */}
                <div className="h-px mb-7" style={{ background: 'linear-gradient(90deg, transparent, rgba(125,211,252,.2) 50%, transparent)' }} />
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                    <label htmlFor="nombre"
                      ...
                      style={{ color: 'rgba(125,211,252,.8)' }}>
                      Nombre completo
                    </label>
                    <input
                      id="nombre"
                  ...
                  <button
                    ...
                    style={{ background: '#7dd3fc', color: '#05090f', boxShadow: '0 8px 28px rgba(125,211,252,.3)' }}
                    onMouseEnter={e => { if (!loading) { e.currentTarget.style.background = '#bae6fd'; e.currentTarget.style.transform = 'translateY(-2px)'; e.currentTarget.style.boxShadow = '0 12px 36px rgba(125,211,252,.45)' } }}
                    onMouseLeave={e => { if (!loading) { e.currentTarget.style.background = '#7dd3fc'; e.currentTarget.style.transform = ''; e.currentTarget.style.boxShadow = '0 8px 28px rgba(125,211,252,.3)' } }}
                  >
                    {loading ? (
                      <>
                ...
                <Link
                  ...
                  onMouseEnter={e => { e.currentTarget.style.borderColor = 'rgba(125,211,252,.5)'; e.currentTarget.style.color = '#7dd3fc'; e.currentTarget.style.background = 'rgba(125,211,252,.06)' }}
