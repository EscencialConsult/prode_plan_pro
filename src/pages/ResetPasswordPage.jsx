            ...
            {!validando && !tokenValido && (
              <div className="text-center py-2">
                ...
                <Link
                  ...
                  style={{ background: '#7dd3fc', color: '#05090f', boxShadow: '0 8px 28px rgba(125,211,252,.3)', textDecoration: 'none' }}
            ...
            {!validando && tokenValido && !done && (
              <>
                <div className="mb-7">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="font-body text-xs uppercase tracking-widest font-bold"
                      style={{ color: 'rgba(125,211,252,.7)' }}>
                      Nueva contraseña
                    </span>
                  </div>
                  ...
                  {userInfo && (
                    <p className="font-body text-sm mt-2" style={{ color: 'rgba(255,255,255,.45)' }}>
                      Hola <span style={{ color: '#7dd3fc', fontWeight: 600 }}>{userInfo.nombre}</span>, elegí una contraseña nueva para tu cuenta.
                    </p>
                  )}
                </div>
                ...
                <div className="h-px mb-6"
                  style={{ background: 'linear-gradient(90deg, transparent, rgba(125,211,252,.2) 50%, transparent)' }} />
