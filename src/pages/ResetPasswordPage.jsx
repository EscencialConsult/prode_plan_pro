            ...
            {!validando && !tokenValido && (
              <div className="text-center py-2">
                ...
                <Link
                  ...
                  style={{ background: '#A6C934', color: '#05090f', boxShadow: '0 8px 28px rgba(166,201,52,.3)', textDecoration: 'none' }}
                  onMouseEnter={e => { e.currentTarget.style.background = '#bde04b'; e.currentTarget.style.transform = 'translateY(-2px)' }}
              ...
              <>
                <div className="mb-7">
                  ...
                  {userInfo && (
                    <p className="font-body text-sm mt-2" style={{ color: 'rgba(255,255,255,.45)' }}>
                      Hola <span style={{ color: '#A6C934', fontWeight: 600 }}>{userInfo.nombre}</span>, elegí una contraseña nueva para tu cuenta.
                    </p>
                  )}
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <button
                    ...
                    style={{ background: '#A6C934', color: '#05090f', boxShadow: '0 8px 28px rgba(166,201,52,.3)' }}
