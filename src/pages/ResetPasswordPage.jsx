            ...
            {!validando && !tokenValido && (
              <div className="text-center py-2">
                ...
                <Link
                  ...
                  style={{ background: '#E30613', color: '#fff', boxShadow: '0 8px 28px rgba(227,6,19,.3)', textDecoration: 'none' }}
                ...
                <div className="mb-7">
                  ...
                  {userInfo && (
                    <p className="font-body text-sm mt-2" style={{ color: 'rgba(255,255,255,.45)' }}>
                      Hola <span style={{ color: '#E30613', fontWeight: 600 }}>{userInfo.nombre}</span>, elegí una contraseña nueva para tu cuenta.
                    </p>
                  )}
                </div>
