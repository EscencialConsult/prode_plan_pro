            ...
            {!lb && bets.map(bet => {
              ...
              return (
                <div key={bet.id}
                  ...
                  onMouseEnter={e => { e.currentTarget.style.borderColor = '#A6C934'; e.currentTarget.style.boxShadow = '0 4px 16px rgba(166,201,52,.15)' }}
                ...
                >
                  ...
                  <div style={{ textAlign: 'center' }}>
                    ...
                    <span style={{
                      ...
                      padding: '.3rem .7rem',
                      borderRadius: 99,
                      background: activa ? 'rgba(34,197,94,.1)' : 'rgba(166,201,52,.1)',
                      color: activa ? '#22c55e' : '#8fae27',
                    }}>
