            ...
            {!lb && bets.map(bet => {
              ...
              return (
                <div key={bet.id}
                  ...
                  onMouseEnter={e => { e.currentTarget.style.borderColor = '#E30613'; e.currentTarget.style.boxShadow = '0 4px 16px rgba(227,6,19,.15)' }}
                ...
                >
                  ...
                  <div style={{ textAlign: 'center' }}>
                    ...
                    <span style={{
                      ...
                      padding: '.3rem .7rem',
                      borderRadius: 99,
                      background: activa ? 'rgba(34,197,94,.1)' : 'rgba(227,6,19,.1)',
                      color: activa ? '#22c55e' : '#A8030C',
                    }}>
