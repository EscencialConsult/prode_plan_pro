            ...
            {done ? (
              ...
              <div className="text-center py-2">
                <div
                  ...
                  style={{
                    ...
                    border: '2px solid rgba(227,6,19,.45)',
                  }}
                >
                  <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#E30613" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <Link
                  ...
                  onMouseEnter={e => { e.currentTarget.style.color = '#C7050F' }}
                  onMouseLeave={e => { e.currentTarget.style.color = '#E30613' }}
                >
                  ← Volver al login
                </Link>
              </div>
              ...
              <>
                ...
                <div className="h-px mb-6"
                  style={{ background: 'linear-gradient(90deg, transparent, rgba(227,6,19,.2) 50%, transparent)' }} />
