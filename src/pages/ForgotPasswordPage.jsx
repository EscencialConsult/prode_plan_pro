          ...
          <div className="px-8 py-8">
            ...
            {done ? (
              ...
              <div className="text-center py-2">
                ...
                >
                  <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#c02727" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <Link
                  ...
                  style={{ color: '#c02727', textDecoration: 'none' }}
                  onMouseEnter={e => { e.currentTarget.style.color = '#d83a3a' }}
                  onMouseLeave={e => { e.currentTarget.style.color = '#c02727' }}
                >
                  ← Volver al login
                </Link>
              </div>
