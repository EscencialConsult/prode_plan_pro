...
.rk-detail-btn-podio.active { background:#0c182b;color:#0057B8 }
...
.rk-detail-btn-mini.active { background:#0c182b;color:#0057B8 }
      ...
      <div style={{ maxWidth: 1400, margin: '0 auto', padding: '2rem 1.5rem 3rem' }}>
        ...
        <div className="rk-in" style={{ marginBottom: '1.5rem' }}>
          <h1 style={{
            ...
            <span style={{ color: '#0057B8' }}>ADMIN</span>
          </h1>
...
function PrediccionRow({ pred, apuesta }) {
  ...
  if (puntosDlBackend !== null) {
    ...
    if (puntosDlBackend === ptsExacto) {
      ...
      borderC = '#0057B840'; bgC = '#0057B80a'; badge = { c: '#0057B8', label: `+${puntosDlBackend}` }
    ...
    else if (dif) { borderC = '#0057B840'; bgC = '#0057B80a'; badge = { c: '#0057B8', label: `+${ptsDif}` } }
          ...
          {otros.map((u, idx) => (
            ...
            >
              ...
              <div style={{ display: 'flex', gap: 4, justifyContent: 'flex-start' }}>
                {[{ v: u.aciertos_exactos, c: '#22c55e' }, { v: u.aciertos_diferencia || 0, c: '#0057B8' }].map((x, i) => (
                  x.v > 0 && (
      ...
      {exp && (
        <div style={{ display: 'flex', flexDirection: 'column', gap: 6, paddingTop: 12 }}>
          {otros.map((u, idx) => {
            ...
            return (
              <div key={u.user_id} style={{
                background: isMe ? 'rgba(255,255,255,.75)' : '#fff',
                border: isMe ? '1.5px solid #0057B8' : '1px solid #f5f3ee',
                boxShadow: isMe ? '0 0 0 1px rgba(255,255,255,.25), 0 2px 8px rgba(235,195,43,.12)' : 'none',
                borderRadius: 10,
                overflow: 'hidden',
                transition: 'all .15s',
              }}>
                ...
                <div style={{
                  ...
                  <div style={{ minWidth: 0 }}>
                    <p style={{ fontWeight: isMe ? 700 : 500, fontSize: 11, color: isMe ? '#0057B8' : '#0c182b', margin: '0 0 1px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                      {u.nombre}
                      {isMe && (
                        <span style={{
                          fontSize: 8,
