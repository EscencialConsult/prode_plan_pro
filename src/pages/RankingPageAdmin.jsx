...
.rk-detail-btn-podio.active { background:#0c182b;color:#E30613 }
...
.rk-detail-btn-mini.active { background:#0c182b;color:#E30613 }
      ...
      <div style={{ maxWidth: 1400, margin: '0 auto', padding: '2rem 1.5rem 3rem' }}>
        ...
        <div className="rk-in" style={{ marginBottom: '1.5rem' }}>
          <h1 style={{
            ...
            <span style={{ color: '#E30613' }}>ADMIN</span>
          </h1>
...
function PrediccionRow({ pred, apuesta }) {
  ...
  if (puntosDlBackend !== null) {
    ...
    if (puntosDlBackend === ptsExacto) {
      ...
      borderC = '#E3061340'; bgC = '#E306130a'; badge = { c: '#E30613', label: `+${puntosDlBackend}` }
    ...
    else if (dif) { borderC = '#E3061340'; bgC = '#E306130a'; badge = { c: '#E30613', label: `+${ptsDif}` } }
      ...
      {exp && (
        <div style={{ display: 'flex', flexDirection: 'column', gap: 6, paddingTop: 12 }}>
          {otros.map((u, idx) => {
            ...
            return (
              <div key={u.user_id} style={{
                background: isMe ? 'rgba(227,6,19,.1)' : '#fff',
                border: isMe ? '1.5px solid #E30613' : '1px solid #f5f3ee',
                boxShadow: isMe ? '0 0 0 1px rgba(227,6,19,.3), 0 2px 8px rgba(227,6,19,.12)' : 'none',
                borderRadius: 10,
                overflow: 'hidden',
                transition: 'all .15s',
              }}>
                ...
                <div style={{
                  ...
                  <div style={{ minWidth: 0 }}>
                    <p style={{ fontWeight: isMe ? 700 : 500, fontSize: 11, color: isMe ? '#E30613' : '#0c182b', margin: '0 0 1px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                      {u.nombre}
                      {isMe && (
                        <span style={{
                          fontSize: 8,
