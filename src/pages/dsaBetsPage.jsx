        ...
        <div className="grid gap-4">
          ...
          {filtered.length === 0 && !loading && (
            <div
              ...
              style={{
                background: '#fff',
                border: '1.5px dashed #c8dbcc',
              }}
            >
              <svg
                width="48" height="48" viewBox="0 0 24 24" fill="none"
                stroke="#8aaa8e" strokeWidth="1.5"
              ...
              <p className="font-body font-semibold text-base mb-1" style={{ color: '#4a6b50' }}>
                {filter === 'todas'
              ...
              <p className="font-body text-xs" style={{ color: '#8aaa8e' }}>
                {filter === 'todas'
          ...
          {filtered.length === 0 && loading && (
            <div className="text-center py-16">
              <span className="inline-block w-8 h-8 border-2 border-t-transparent rounded-full animate-spin"
                style={{ borderColor: '#111811', borderTopColor: 'transparent' }} />
